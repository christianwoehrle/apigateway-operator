...
import (
	...
	scheme "github.com/christianwoehrle/apigateway-operator/pkg/generated/clientset/versioned/scheme"
...
type ApiGatewayInterface interface {
	Create(*v1alpha.ApiGateway) (*v1alpha.ApiGateway, error)
	Update(*v1alpha.ApiGateway) (*v1alpha.ApiGateway, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha.ApiGateway, error)
	List(opts v1.ListOptions) (*v1alpha.ApiGatewayList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha.ApiGateway, err error)
	ApiGatewayExpansion
}
...
func newApiGateways(c *CwV1alphaClient, namespace string) *apiGateways {
	return &apiGateways{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *apiGateways) Get(name string, options v1.GetOptions) (result *v1alpha.ApiGateway, err error) {
	result = &v1alpha.ApiGateway{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *apiGateways) List(opts v1.ListOptions) (result *v1alpha.ApiGatewayList, err error) {
	result = &v1alpha.ApiGatewayList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("apigateways").
...
func (c *apiGateways) Create(apiGateway *v1alpha.ApiGateway) (result *v1alpha.ApiGateway, err error) {
	result = &v1alpha.ApiGateway{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("apigateways").
...
func (c *apiGateways) Update(apiGateway *v1alpha.ApiGateway) (result *v1alpha.ApiGateway, err error) {
	result = &v1alpha.ApiGateway{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apigateways").
...
func (c *apiGateways) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha.ApiGateway, err error) {
	result = &v1alpha.ApiGateway{}
