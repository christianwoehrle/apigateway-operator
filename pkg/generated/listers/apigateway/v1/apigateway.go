...
// List lists all ApiGateways in the indexer for a given namespace.
func (s apiGatewayNamespaceLister) List(selector labels.Selector) (ret []*v1.ApiGateway, err error) {
...
// Get retrieves the ApiGateway from the indexer for a given namespace and name.
func (s apiGatewayNamespaceLister) Get(name string) (*v1.ApiGateway, error) {
